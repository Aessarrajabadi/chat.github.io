  ...
  <h3 class="text-center">About Us</h3>
    ...
    <div class="row mt-5 mb-4">
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
        <div>
        <div class="pl-3 pr-2">
          <h5 class="card-title">Asrbadi</h5>
          ...
          <a href="#" class="btn btn-success mt-2 mr-2">About Me</a>
          <a href="#" class="btn mt-2 mr-2 btn-danger">Projects</a>
        </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-5 ml-auto mr-auto d-flex align-items-center mt-4 mt-md-0">
      <img alt="developer" style="clip-path: circle(45%);" class="col-md-7 col-lg-6 ml-auto mr-auto d-flex align-items-center" src="img/asrbadi.jpg"  />
